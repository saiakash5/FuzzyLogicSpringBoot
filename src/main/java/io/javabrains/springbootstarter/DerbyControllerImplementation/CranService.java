...
import io.javabrains.springbootstarter.RetreivalServicePackage.Stemmer;
...
public class CranService {
    ...
    public String file_path = "/Users/sai/Documents/workspace_intelli/RESTAPI_Implementation/src/main/java/io/javabrains/springbootstarter/RetreivalServicePackage/input_res/cran.txt";
//    CranService() throws IOException {
//        addAll();
//    }

    @Autowired
    public CranRepository cranRepository;
...
//        return cran_docs;
    ...
    //Adding all documents from cran to derby
        ...
        while ((part1 = br.readLine()) != null)                //tokenizing
        {
            ...
            while (st1.hasMoreTokens()) {
                ...
                if (stempr.contains(".I"))                        //setting document id
                {
                    after_W = false;
                    if (docid > 0) {
                        Cran c = new Cran(new String(docid+""),sin);

                        //Creating new Cran object with Doc id and Content and saving to Derby.
                        cranRepository.save(c);
//                        doc.put(docid, sin);
                        sin = "";
                    }
